...
const ShowModalForTableSelectionInTheDropDownForChild = ({
  showDropDownModal,
  handleDropClose,
  modalSpecificData,
  setChildMenuId,
...
export default ShowModalForTableSelectionInTheDropDownForChild;
