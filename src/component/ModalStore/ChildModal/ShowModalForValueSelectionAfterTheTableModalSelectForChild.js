...
const ShowModalForValueSelectionAfterTheTableModalSelectForChild = ({
  showChildModal2,
  setShowChildModal2,
  selectedListName,
  handleErrorClose,
  ...
  return (
    <div>
      <Modal show={showChildModal2} onHide={() => setShowChildModal2(false)}>
        <Modal.Header>
...
export default ShowModalForValueSelectionAfterTheTableModalSelectForChild;
