...
const ChildCalculationModal = ({
  ...
  pageFormulaDetails,
  setField1ValidationDetails,
  field1ValidationDetails,
  setFieldFormulaValidationDetails,
  fieldFormulaValidationDetails,
  setField2ValidationDetails,
  field2ValidationDetails,
  setFieldTargetValidationDetails,
  setFormulaTargetDetails,
  fieldTargetValidationDetails,
  submitForm,
}) => {
  return (
    <div>
